...
def compute_autoais(data,
    ...
    autoais_log = []
    for qid, item in tqdm(enumerate(data)):
...
def main():
    ...
    # Remove the data that does not have the output field
    data = [d for d in data if 'output' in d]
    logger.info(f"Total number of data: {len(data)}")
